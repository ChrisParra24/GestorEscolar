...
exports.get = async (req,res) => {
    ...
    const query = "SELECT * FROM maestros WHERE status = $1";
...
exports.create = async (req, res) => {
    ...
    const query = "INSERT INTO maestros (status) VALUES ($1)";
...
exports.delete = async (req,res) => {
    const nombre = req.params.nombre;
    const query = "DELETE FROM maestros WHERE status = $1";
...
exports.update = async (req,res) => {
    ...
    const query = "UPDATE maestros SET status = $1 WHERE status = $2";
